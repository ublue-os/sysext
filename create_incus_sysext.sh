...
#make deps
export CGO_CFLAGS="-I${SCRIPTFOLDER}/${SYSEXTNAME}/usr/local/include/"
export CGO_LDFLAGS="-L${SCRIPTFOLDER}/${SYSEXTNAME}/usr/local/lib/"
export CGO_LDFLAGS_ALLOW="(-Wl,-wrap,pthread_create)|(-Wl,-z,now)"
make
cp "${GOPATH}/bin/incus" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/incusd" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/fuidshift" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/generate" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/incus-agent" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/incus-benchmark" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/incus-migrate" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/incus-user" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/lxc-to-incus" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"
cp "${GOPATH}/bin/lxd-to-incus" "${SCRIPTFOLDER}/${SYSEXTNAME}/usr/bin/"

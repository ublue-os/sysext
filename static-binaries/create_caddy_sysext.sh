...
ls -la /bakery/chainguard

mkdir -p "${SYSEXTNAME}"/usr/bin

mkdir -p "${SYSEXTNAME}"/usr/share/caddy

cp /bakery/chainguard/caddy "${SYSEXTNAME}"/usr/bin/
cp /bakery/chainguard/index.html "${SYSEXTNAME}"/usr/share/caddy/
